...
function altaMonitor($nombre,$dni,$fecha,$email,$apell1,$foto,$usuario,$telefono,$pass,$tipo)
{
	$mysqli=$this->conexionBD();
	...
	if ($mysqli->query("INSERT INTO `Entrenador`(`Usuario`, `Password`, `Nombre`, `Apellidos`,`FOTO`, `DNI`, `Email`, `FechaNac`, `Telefono`, `Tipo`) VALUES ('$usuario','$pass','$nombre','$apell1','$foto','$dni','$email','$fecha','$telefono','$tipo')")==TRUE)
	{
		?>
		<script>
		</script>
 ...
 function modificarMonitor($nombre,$dni,$fecha,$email,$apell1,$foto,$usuario,$telefono,$pass,$tipo){

 	$mysqli=$this->conexionBD();
 	$query="UPDATE `Entrenador` SET `Usuario`='$usuario',`Password`='$pass',`Nombre`='$nombre',`Apellidos`='$apell1',`FOTO`='$foto',`DNI`='$dni',`Email`='$email',`FechaNac`='$fecha',`Telefono`='$telefono',`Tipo`='$tipo' WHERE DNI='$dni'";
