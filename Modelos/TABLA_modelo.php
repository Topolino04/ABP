...
function ConectarBD(){
    $this->mysqli = new mysqli("localhost", "root", "", "gimnasio_bd");
...
function ListarEjercicios(){
	//SELECT *, true FROM tabla_contiene_ejercicios, ejercicio WHERE Ejercicio_id_Ejercicio = id_Ejercicio AND Tabla_id_Tabla = 5;
	$this->ConectarBD();
