...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Gimnasio_BD`.`Sesion` (
  `Entrenador_id_Usuario` VARCHAR(10) NOT NULL,
  `Deportista_id_Usuario` VARCHAR(10) NOT NULL,
  `Fecha` DATETIME NOT NULL,
  `Comentario` VARCHAR(150) NULL,
  PRIMARY KEY (`Entrenador_id_Usuario`, `Deportista_id_Usuario`),
  INDEX `fk_Entrenador_has_Deportista_Deportista1_idx` (`Deportista_id_Usuario` ASC),
  INDEX `fk_Entrenador_has_Deportista_Entrenador1_idx` (`Entrenador_id_Usuario` ASC),
  CONSTRAINT `fk_Entrenador_has_Deportista_Entrenador1`
    FOREIGN KEY (`Entrenador_id_Usuario`)
    REFERENCES `Gimnasio_BD`.`Entrenador` (`DNI`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Entrenador_has_Deportista_Deportista1`
    FOREIGN KEY (`Deportista_id_Usuario`)
    REFERENCES `Gimnasio_BD`.`Deportista` (`DNI`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
